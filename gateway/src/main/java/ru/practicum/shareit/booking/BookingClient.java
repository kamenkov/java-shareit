...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAll(Long userId, String state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findAllForOwner(Long userId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
